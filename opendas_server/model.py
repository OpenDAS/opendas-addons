...
class das_data_model(osv.osv):
	...
	_columns = {
		...
		#Numeric, Alpha, EAN, ... 
		'ctrl': fields.selection([('int',_('Integer')),('num',_('Float')),('alpha',_('Numbers and characters')),('alphaMin',_('Lower and upper characters and numbers')),('ean13',_('EAN13')),('ean128',_('EAN 128')),('char',_('Upper and lower characters'))], 'Validation method', select=True),
