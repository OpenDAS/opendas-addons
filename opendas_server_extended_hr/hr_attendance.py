...
#        context['tps'] = 1
        ...
        translation = {
            ...
            "mrp.production.workcenter.line.subwork":_("Production line division"),
            #??
            "planni":"Opération",
        }
        ...
        for employee in self.pool.get('hr.employee').browse(cr,uid,ids):
            try:
                ...
                if not in_model  :
                    ...
                    attendance_id = employee.sign_in_action(context)
                ...
                # SORTIE
                    ...
                    attendance_id = employee.sign_out_action(context)
                    context['time_delta'] = employee.get_time_delta(context)[employee.id]['float']
                    context['alone'] = True
